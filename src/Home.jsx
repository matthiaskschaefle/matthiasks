...
const WORK = [
  ...
  },
  {
    ...
    title: "A healthcare website patients can trust",
    description: "Patients arrived with the same questions before booking: procedures, prices, insurance. Research, IA and a page system that answers them, designed for a plastic surgeon.",
    result: "Live since 2024, maintained by the client.",
